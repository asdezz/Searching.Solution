...
namespace Searching.BE.WF.NotificationService.ApiService.Activities {
    ...
    public partial class DeleteAnnouncing : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(DeleteAnnouncing).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(DeleteAnnouncing));
        ...
        private string FindResource() {
            string[] resources = typeof(DeleteAnnouncing).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.DeleteAnnouncing." +
                        "g.xaml") || resource.Equals("Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.DeleteAnnouncing.g" +
                        ".xaml"))) {
                    return resource;
                }
            }

...
namespace Searching.BE.WF.NotificationService.ApiService.Activities {
    ...
    public partial class AddToFavorite : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.OutArgument<Searching.BE.WF.NotificationService.ApiService.ReturnValue> _AddToFavoriteResult;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<Searching.BE.WF.NotificationService.ApiService.ReturnValue> AddToFavoriteResult {
            get {
                return this._AddToFavoriteResult;
            }
            set {
                this._AddToFavoriteResult = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AddToFavorite).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AddToFavorite));
        ...
        private string FindResource() {
            string[] resources = typeof(AddToFavorite).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.AddToFavorite.g.x" +
                        "aml") || resource.Equals("Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.AddToFavorite.g.xa" +
                        "ml"))) {
                    return resource;
                }
            }

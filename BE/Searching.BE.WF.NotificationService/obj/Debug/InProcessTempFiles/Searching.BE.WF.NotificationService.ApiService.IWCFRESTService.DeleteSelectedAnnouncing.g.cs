...
namespace Searching.BE.WF.NotificationService.ApiService.Activities {
    ...
    public partial class DeleteSelectedAnnouncing : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public DeleteSelectedAnnouncing() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(DeleteSelectedAnnouncing).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(DeleteSelectedAnnouncing));
        ...
        private string FindResource() {
            string[] resources = typeof(DeleteSelectedAnnouncing).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.DeleteSelectedAnn" +
                        "ouncing.g.xaml") || resource.Equals("Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.DeleteSelectedAnno" +
                        "uncing.g.xaml"))) {
                    return resource;
                }
            }

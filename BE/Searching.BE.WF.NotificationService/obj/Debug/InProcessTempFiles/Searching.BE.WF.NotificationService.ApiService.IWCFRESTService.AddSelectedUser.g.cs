...
namespace Searching.BE.WF.NotificationService.ApiService.Activities {
    ...
    public partial class AddSelectedUser : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private string _EndpointConfigurationName;
        
        private System.Activities.InArgument<Searching.BE.WF.NotificationService.ApiService.Selected_User> _user;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<Searching.BE.WF.NotificationService.ApiService.Selected_User> user {
            get {
                return this._user;
            }
            set {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AddSelectedUser).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AddSelectedUser));
        ...
        private string FindResource() {
            string[] resources = typeof(AddSelectedUser).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.AddSelectedUser.g" +
                        ".xaml") || resource.Equals("Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.AddSelectedUser.g." +
                        "xaml"))) {
                    return resource;
                }
            }

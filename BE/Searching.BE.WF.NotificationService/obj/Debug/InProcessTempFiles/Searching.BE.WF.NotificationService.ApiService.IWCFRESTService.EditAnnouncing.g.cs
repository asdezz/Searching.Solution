...
namespace Searching.BE.WF.NotificationService.ApiService.Activities {
    ...
    public partial class EditAnnouncing : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(EditAnnouncing).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(EditAnnouncing));
        ...
        private string FindResource() {
            string[] resources = typeof(EditAnnouncing).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.EditAnnouncing.g." +
                        "xaml") || resource.Equals("Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.EditAnnouncing.g.x" +
                        "aml"))) {
                    return resource;
                }
            }

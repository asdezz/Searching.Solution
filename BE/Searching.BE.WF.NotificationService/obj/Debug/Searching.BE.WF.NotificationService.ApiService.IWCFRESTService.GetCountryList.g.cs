...
namespace Searching.BE.WF.NotificationService.ApiService.Activities {
    ...
    public partial class GetCountryList : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private string _EndpointConfigurationName;
        
        private System.Activities.OutArgument<System.Collections.Generic.List<Searching.BE.WF.NotificationService.ApiService.Country>> _GetCountryListResult;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<System.Collections.Generic.List<Searching.BE.WF.NotificationService.ApiService.Country>> GetCountryListResult {
            get {
                return this._GetCountryListResult;
            }
            set {
                this._GetCountryListResult = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(GetCountryList).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(GetCountryList));
        ...
        private string FindResource() {
            string[] resources = typeof(GetCountryList).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.GetCountryList.g." +
                        "xaml") || resource.Equals("Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.GetCountryList.g.x" +
                        "aml"))) {
                    return resource;
                }
            }

...
namespace Searching.BE.WF.NotificationService.ApiService.Activities {
    ...
    public partial class GetSubscribers : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private string _EndpointConfigurationName;
        
        private System.Activities.OutArgument<System.Collections.Generic.List<int>> _GetSubscribersResult;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<System.Collections.Generic.List<int>> GetSubscribersResult {
            get {
                return this._GetSubscribersResult;
            }
            set {
                this._GetSubscribersResult = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(GetSubscribers).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(GetSubscribers));
        ...
        private string FindResource() {
            string[] resources = typeof(GetSubscribers).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.GetSubscribers.g." +
                        "xaml") || resource.Equals("Searching.BE.WF.NotificationService.ApiService.IWCFRESTService.GetSubscribers.g.x" +
                        "aml"))) {
                    return resource;
                }
            }

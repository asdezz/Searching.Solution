...
namespace Searching.BE.Service
{
    ...
    public interface IWCFRESTService
    {
        ...
        [OperationContract]
        [WebGet(RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json,UriTemplate ="GetAnnouncing")]
        //Возвращает весь список объявлений
        List<Announcing> GetAnnouncing();
        ...
        //Возвращает объявления по заданной категории
